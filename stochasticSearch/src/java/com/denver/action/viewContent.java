...
public class viewContent extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.setAttribute("entryList", pt.getAllStudentEntries());//adding inmemory stored file data as a parameter

            request.getRequestDispatcher("/WEB-INF/pages/process.jsp").forward(request, response);
